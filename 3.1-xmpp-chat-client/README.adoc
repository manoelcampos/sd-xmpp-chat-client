= Aplicativo de Mensagens Instantâneas usando Protocolo XMPP em Java (link:https://kinolien.github.io/gitzip/?download=/manoelcampos/sd-xmpp-chat-client/tree/master/3.1-xmpp-chat-client[zip])
